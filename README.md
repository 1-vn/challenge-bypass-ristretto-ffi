# challenge-bypass-ristretto-ffi [![Build Status](https://travis-ci.org/onevn/challenge-bypass-ristretto-ffi.svg?branch=master)](https://travis-ci.org/onevn/challenge-bypass-ristretto-ffi)

**A FFI crate, C++ and Golang wrappers to expose functionality from [challenge-bypass-ristretto](https://github.com/1-vn/challenge-bypass-ristretto)**
